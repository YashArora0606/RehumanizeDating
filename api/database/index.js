  ...
  async.waterfall(
    [
      ...
      function (results, next) {
        ...
        client.query(
          'CREATE TABLE IF NOT EXISTS calls (ID UUID PRIMARY KEY DEFAULT gen_random_uuid(), Complete BOOL, UserID UUID REFERENCES users(ID), SessionID UUID, StartTime STRING, EndTime STRING);',
          next,
        );
      },
    ],
