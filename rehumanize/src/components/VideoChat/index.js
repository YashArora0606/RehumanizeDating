...
export default class VideoChat extends React.Component {
  ...
  onButtonClick = () => {
    ...
    this.setState({
      currentPrompt: this.state.prompts[
            ...
            <div class="container">
              ...
              <div className="ui-area">
                <div className="prompt-header titled">
                  <header>I want to know...</header>
                </div>
                <div className="prompt subtitled">
                  <header>{this.state.currentPrompt}</header>
                </div>
                <button className="new-prompt-btn" onClick={this.onButtonClick}>
                  New prompt
                </button>
              </div>
            </div>
